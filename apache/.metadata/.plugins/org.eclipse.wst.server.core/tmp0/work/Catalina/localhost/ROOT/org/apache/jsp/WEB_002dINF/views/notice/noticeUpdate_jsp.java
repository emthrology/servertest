 ...
 * Generated at: 2019-05-19 15:38:13 UTC
...
public final class noticeUpdate_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(m==null) {
      ...
      out.write("\t\t\t\t\t\t<th>작성자</th>\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(n.getNoticeAuthor() );
      out.write("</td>\n");
      out.write("\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t<th>첨부파일</th>\n");
      out.write("\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" id=\"status\" name=\"status\" value=\"stay\"><!-- 파일을 삭제할 것인지 구분하는 hidden input (value == \"stay\"||\"delete\") -->\n");
      out.write("\t\t\t\t\t\t\t");
 if(n.getFilepath() != null) { 
      ...
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t<th>내용</th>\n");
      out.write("\t\t\t\t\t\t<td><textarea name=\"noticeContent\" class=\"form-control\" rows=\"3\">");
