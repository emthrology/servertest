 ...
 * Generated at: 2019-05-19 12:58:06 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.views.member1;
...
public final class searchMember_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<link rel=\"stylesheet\" href=\"/css/member1/login.css\">\n");
 ...
 if(m==null) {
      ...
      out.write("</header>");
      out.write("\n");
      out.write("\t\t<section id=\"searchIdSection\" style=\"width:900px; margin-left:10%; float:left;\">\n");
      out.write("\t\t\t<div style=\"width:300px; height:400px; float:left;\">\n");
      out.write("\t\t\t\t<form action=\"/searchId\" method=\"post\" id = \"searchId\">\n");
      out.write("\t\t\t\t\t<h2>아이디 찾기</h2>\n");
      out.write("\t\t\t\t\t<span>이름과 전화번호를 입력하세요.</span>\n");
      out.write("\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t<li><label for=\"memberName\">이름</label></li>\n");
      out.write("\t\t\t\t\t\t<li><input type=\"text\" name=\"memberName\" id=\"memberName\" class=\"form-control\"></li><br>\n");
      out.write("\t\t\t\t\t\t<li><label for=\"phone\">전화번호</label></li>\n");
      out.write("\t\t\t\t\t\t<li><input type=\"text\" name=\"phone\" id=\"phone\" class=\"form-control\"></li>\n");
      out.write("\t\t\t\t\t\t<li id=\"btn-wrapper\">\n");
      out.write("\t\t\t\t\t\t\t<br>\n");
      out.write("\t\t\t\t\t\t\t<button class=\"btn btn-outline-danger btn-lg\" type=\"submit\">찾기</button>\n");
      out.write("\t\t\t\t\t\t\t<button class=\"btn btn-outline-danger btn-lg\" type=\"reset\">초기화</button>\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t</form>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div style=\"width:300px; height:400px; float:left; margin-left:10%;\">\n");
      out.write("\t\t\t\t<form action=\"/searchPw\" method=\"post\" id = \"searchId\">\n");
      out.write("\t\t\t\t\t<h2>비밀번호찾기</h2>\n");
      out.write("\t\t\t\t\t<span>아이디와 이메일을 입력하세요.</span>\n");
      out.write("\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t<li><label for=\"memberId\">아이디</label></li>\n");
      out.write("\t\t\t\t\t\t<li><input type=\"text\" name=\"memberId\" id=\"memberId\" class=\"form-control\"></li><br>\n");
      out.write("\t\t\t\t\t\t<li><label for=\"email\">이메일</label></li>\n");
      out.write("\t\t\t\t\t\t<li><input type=\"text\" name=\"email\" id=\"email\" class=\"form-control\"></li>\n");
      out.write("\t\t\t\t\t\t<li id=\"btn-wrapper\">\n");
      out.write("\t\t\t\t\t\t\t<br>\n");
      out.write("\t\t\t\t\t\t\t<button class=\"btn btn-outline-danger btn-lg\" type=\"submit\">찾기</button>\n");
      out.write("\t\t\t\t\t\t\t<button class=\"btn btn-outline-danger btn-lg\" type=\"reset\">초기화</button>\n");
