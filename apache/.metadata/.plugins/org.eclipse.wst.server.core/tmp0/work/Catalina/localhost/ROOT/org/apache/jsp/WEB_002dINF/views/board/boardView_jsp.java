 ...
 * Generated at: 2019-05-19 07:06:58 UTC
...
public final class boardView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1557896013000L));
  }
  ...
  static {
    ...
    _jspx_imports_classes.add("board.model.vo.BoardViewData");
 ...
 if(m==null) {
      ...
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<th colspan=\"2\" style=\"font-size:20px; font-weight:bold;\">자유제시판</th>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<th>제목</th>\n");
      out.write("\t\t\t\t\t<td>");
 ...
 if(b.getFilepath() != null) { 
      out.write("\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<!-- 첨부파일형식이 아니라 같이 띄워줘야함  -->\n");
      out.write("\t\t\t\t\t<td colspan=\"2\">\n");
      out.write("\t\t\t\t\t\t<img src=\"");
      out.print(b.getFilepath() );
      out.write("\" width=\"80%;\">\n");
      out.write("\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t");
      ...
      out.write("\t\t\t\t\t<th>내용</th>\n");
      out.write("\t\t\t\t\t<td>");
      out.print(b.getBoardContent().replaceAll("\r\n", "<br>") );
      out.write("</td><!-- 개행문자 변환 -->\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<th colspan=\"2\">\n");
      out.write("\t\t\t\t\t\t<a href=\"/boardUpdate?boardNo=");
      out.print(b.getBoardNo() );
      out.write("\" class=\"btn btn-outline-primary btn-sm\">수정하기</a>\n");
      out.write("\t\t\t\t\t\t<a href=\"/boardDelete?boardNo=");
      out.print(b.getBoardNo() );
      out.write("\" class=\"btn btn-outline-primary btn-sm\">삭제하기</a><!-- 간단히 실습 과제임 -->\n");
      out.write("\t\t\t\t\t\t<a href=\"/boardList\" class=\"btn btn-outline-primary btn-sm\">목록으로</a>\n");
      out.write("\t\t\t\t\t</th>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<th colspan=\"2\">\n");
      ...
      out.print(b.getBoardNo() );
      out.write(" - 1\" class=\"btn btn-outlineoprimary btn-sm\">이전글 </a>\n");
      out.write("\t\t\t\t\t\t<a href=\"/boardView?boardNo=");
      out.print(b.getBoardNo() );
      out.write(" + 1\" class=\"btn btn-outlineoprimary btn-sm\">다음글 </a>\n");
      out.write("\t\t\t\t\t</th>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t</table>\n");
      out.write("\t\t</div>\n");
